...
int main() 
{
    ...
    printf("Enter the size of the 1st subset (max %d):\n", size);
    scanf("%d", &size1);
    if (size1 > size) 
    {
        printf("Invalid size for subset 1. It cannot exceed the parent set size.\n");
        return 1; 
    }
    ...
    printf("Enter the size of the 2nd subset (max %d):\n", size);
    scanf("%d", &size2);
    if (size2 > size) 
    {
        printf("Invalid size for subset 2. It cannot exceed the parent set size.\n");
        return 1; 
    }
